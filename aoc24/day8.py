def parse_day8_input(user_input: list[str]):
    """
...
def solve_day8_puzzle_part1(user_input: list[str]) -> int:
    """
...
def solve_day8_puzzle_part2(user_input: list[str]) -> int:
    """
    Function to solve part 1 of the puzzle for Day 8.
    Args:
        user_input (list[str]): The user input.
...
def solve_day8_puzzle(user_input: list[str], part: int) -> int:
    """
