def parse_day9_input(user_input: str):
    """
...
def solve_day9_puzzle_part1(user_input: str) -> int:
    """
...
def solve_day9_puzzle_part2(user_input: str) -> int:
    """
    Function to solve part 1 of the puzzle for Day 9.
    Args:
        user_input (str): The user input.
...
def solve_day9_puzzle(user_input: str, part: int) -> int:
    """
